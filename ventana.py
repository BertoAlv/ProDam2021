...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.lblClientes.setGeometry(QtCore.QRect(470, 10, 191, 20))
        font = QtGui.QFont()
...
"}")
        ...
        self.btnGrabaCli.setGeometry(QtCore.QRect(460, 360, 75, 23))
        font = QtGui.QFont()
        ...
        self.btnSalir.setGeometry(QtCore.QRect(560, 360, 75, 23))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        ...
        self.line.setGeometry(QtCore.QRect(210, 330, 651, 20))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(210, 120, 631, 27))
        ...
        self.lblApel_2 = QtWidgets.QLabel(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(210, 250, 181, 25))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(210, 290, 611, 25))
        ...
        self.lblPago = QtWidgets.QLabel(self.layoutWidget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(212, 162, 631, 27))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(211, 210, 381, 27))
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(210, 80, 594, 37))
        ...
        self.lblFchAlta = QtWidgets.QLabel(self.layoutWidget5)
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        ...
        self.txtFchAlta = QtWidgets.QLineEdit(self.layoutWidget5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btnFchAlta = QtWidgets.QPushButton(self.layoutWidget5)
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        ...
        self.tabClientes.setGeometry(QtCore.QRect(90, 400, 901, 361))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        ...
        self.btnLimpiar.setGeometry(QtCore.QRect(810, 80, 31, 31))
        self.btnLimpiar.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("img/refrescar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
